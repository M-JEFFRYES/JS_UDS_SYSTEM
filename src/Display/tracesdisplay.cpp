...
TracesDisplay::TracesDisplay(QWidget* parent) : QFrame(parent),
...
void TracesDisplay::setDataLineColours(QVector<QPen> line_colours) {
    data_line_colours = line_colours;
}

// INIT

void TracesDisplay::setSampleWindowLength(int sample_window_length) {
